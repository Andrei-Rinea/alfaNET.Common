...
{
    // TODO : Port to portable class library (XmlReader.Create...)
    public class SimpleFileAuthenticator : IAuthenticator
    {
        private class UserEntry
        {
            ...
            public string GetErrorMessage()
            {
                ...
                if (errors.Any())
                    return "User entry at line {0}, column {1} has " + string.Join(",", errors) + ".";
                return null;
            }
        }
        ...
        private void LoadData()
        {
            ...
            using (configStream)
            using (var xmlReader = new XmlTextReader(configStream) { WhitespaceHandling = WhitespaceHandling.None })
            {
            ...
            var duplicateInfo = CollectionHelper.GetDuplicates(userEntries, (a, b) => string.Equals(a.Name, b.Name, StringComparison.InvariantCultureIgnoreCase)).ToArray();
        ...
        private void ReadUserEntry(XmlTextReader xmlReader, ICollection<UserEntry> userEntries)
        {
            var line = xmlReader.LineNumber;
            var column = xmlReader.LinePosition;
            ...
            if (errorMessage != null)
                _logger.Log(LogLevel.Warn, errorMessage, null, line, column);
            else
        ...
        public AuthenticationResult Authenticate(string username, string password)
        {
            ...
            return string.Equals(computedHashBase64, entry.HashBase64, StringComparison.InvariantCulture) ?
